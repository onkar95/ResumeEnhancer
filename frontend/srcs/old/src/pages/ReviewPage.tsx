  ...
  return (
    <div className="w-full min-w-0 px-4 sm:px-6 lg:px-8 py-6 max-w-[1600px] mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 items-start min-w-0">
        <div
          className={`lg:col-span-2 min-w-0 ${tab === "resume" ? "block" : "hidden lg:block"}`}
        >
        ...
        <div
          className={`space-y-6 min-w-0 ${tab === "assist" ? "block" : "hidden lg:block"}`}
        >
          <div className="card p-6 text-center">
            <h2 className="font-bold text-gray-900 mb-2">AI Assistant</h2>
            <p className="text-sm text-gray-500 mb-4">
              Review suggestions and chat with the AI to regenerate this resume.
            </p>
            <button
              onClick={() => navigate(`/review/${resolvedRunId}/assistant`)}
